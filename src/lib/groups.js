...
// Official World Cup 2026 draw — verified June 2026
// Team order within each group determines round-robin pairings:
//   MD1: T1vT2, T3vT4  |  MD2: T1vT3, T2vT4  |  MD3: T1vT4, T2vT3
export const GROUPS = [
  { name: 'א',  teams: ['מקסיקו',      'דרום אפריקה',        'קוריאה הדרומית', "צ'כיה"             ] },
  { name: 'ב',  teams: ['קנדה',         'בוסניה והרצגובינה',  'קטר',             'שוויץ'             ] },
  { name: 'ג',  teams: ['ברזיל',        'מרוקו',              'האיטי',           'סקוטלנד'           ] },
  { name: 'ד',  teams: ['ארצות הברית',  'פרגוואי',            'אוסטרליה',        'טורקיה'            ] },
  { name: 'ה',  teams: ['גרמניה',       'קוראסאו',            'חוף השנהב',       'אקוודור'           ] },
  { name: 'ו',  teams: ['הולנד',        'יפן',                'שוודיה',          'תוניסיה'           ] },
  { name: 'ז',  teams: ['בלגיה',        'מצרים',              'איראן',           'ניו זילנד'         ] },
  { name: 'ח',  teams: ['ספרד',         'כף ורדה',            'סעודיה',          'אורוגוואי'         ] },
  { name: 'ט',  teams: ['צרפת',         'סנגל',               'עיראק',           'נורווגיה'          ] },
  { name: 'י',  teams: ['ארגנטינה',    "אלג'יריה",            'אוסטריה',         'ירדן'              ] },
  { name: 'יא', teams: ['פורטוגל',      'קונגו הדמוקרטית',    'אוזבקיסטן',       'קולומביה'          ] },
  { name: 'יב', teams: ['אנגליה',       'קרואטיה',            'גאנה',            'פנמה'              ] },
]
